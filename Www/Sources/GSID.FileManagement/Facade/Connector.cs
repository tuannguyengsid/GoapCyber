...
namespace GSID.FileManagement
{
    /// <summary>
    /// Represents a connector which process GSID.FileManagement request
    /// </summary>
    public class Connector
    {
        private IDriver _driver;
        /// <summary>
        /// Initialize new instance of GSID.FileManagement.Connector
        /// </summary>
        ...
        /// <summary>
        /// Process GSID.FileManagement request
        /// </summary>
        /// <param name="request">Request from GSID.FileManagement</param>
        /// <returns>Json response, which must be sent to GSID.FileManagement</returns>
