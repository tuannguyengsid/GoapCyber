...
(function ($) {
    var FMGSIDModal = function ($el, options) { //CustomPlugin
        ...
        plugin.init = function () {
            if (plugin.$element.attr('data-note') != '' && plugin.$element.attr('data-note') != null && plugin.$element.attr('data-note') != undefined)
                plugin._options.footercontent = plugin.$element.attr('data-note');
            if (plugin.$element.attr('data-preview-el') != '' && plugin.$element.attr('data-preview-el') != null && plugin.$element.attr('data-preview-el') != undefined)
                plugin._options.elpreview = plugin.$element.attr('data-preview-el');
            if (plugin.$element.attr('data-elbinding') != '' && plugin.$element.attr('data-elbinding') != null && plugin.$element.attr('data-elbinding') != undefined)
                plugin._options.elbinding = plugin.$element.attr('data-elbinding');
            if (plugin.$element.attr('data-titlemodal') != '' && plugin.$element.attr('data-titlemodal') != null && plugin.$element.attr('data-titlemodal') != undefined)
                plugin._options.titleModal = plugin.$element.attr('data-titlemodal');
            if (plugin.$element.attr('data-url') != '' && plugin.$element.attr('data-url') != null && plugin.$element.attr('data-url') != undefined)
                plugin._options.url = plugin.$element.attr('data-url');
            if (plugin.$element.attr('data-urlstatic') != '' && plugin.$element.attr('data-urlstatic') != null && plugin.$element.attr('data-urlstatic') != undefined)
                plugin._options.urlstatic = plugin.$element.attr('data-urlstatic');
                    ...
                    dblclick: function (event, elfinderInstance) {
                        ...
                        if (fileInfo.mime != 'directory') {
                            ...
                            if (_fmGSIDModal._options.elpreview != '') {
                                var __elpreview = $(_fmGSIDModal._options.elpreview).prop('nodeName').toLowerCase();
                                if (__elpreview == 'img')
                                    $(_fmGSIDModal._options.elpreview).attr('src', _fmGSIDModal._options.urlstatic + file.url);
                                else if (__elpreview == 'a') {
                                    $(_fmGSIDModal._options.elpreview).attr('href', _fmGSIDModal._options.urlstatic + file.url).text(file.name);
                                }
                            }
