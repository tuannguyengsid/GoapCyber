(function ($) {
    ...
    function templateResultCustom(data, container) {
        if (data.element) {
            ...
            if (isSearching) {
                ...
                $switchSpn.addClass("switch-tree gsid-select");
                if ($switchSpn.hasClass("ion-ios-arrow-right"))
                    $switchSpn.removeClass("ion-ios-arrow-right")
                        .addClass("ion-ios-arrow-down");
                else
                    $switchSpn.removeClass("ion-ios-arrow-down")
                        .addClass("ion-ios-arrow-right");
    ...
    function switchAction($select, id, open) {
        ...
        if (open) {
            parent.removeClass("ion-ios-arrow-right")
                .addClass("ion-ios-arrow-down");
            childs.slideDown();
        } else {
            parent.removeClass("ion-ios-arrow-down")
                .addClass("ion-ios-arrow-right");
            childs.slideUp();
        }
    }
    ...
    function open($select) {
        setTimeout(function () {
            ...
            $(".switch-tree").mousedown(function () {
                switchAction($select, $(this).parent().attr("val"), $(this).hasClass("ion-ios-arrow-right"));
