 ...
 * MIT licensed
 *
 * Copyright (C) 2022 g-sid.com - A weekend project by Eddy Nguyen (@eddynguyen@g-sid.com)
 */
...
(function (root, factory) {
    ...
    function _placeTooltip(targetElement, tooltipLayer, arrowLayer) {
        ...
        switch (currentTooltipPosition) {
            case 'top':
                tooltipLayer.style.left = '25px';// change position tooltip// g-sid.com
            ...
            case 'left':
                ...
                var introjsTooltiptext = document.querySelector('.introjs-tooltiptext');
                introjsTooltiptext.style.width = (tooltipLayerPosition.width - 20) + 'px';//g-sid.com
    ...
    function _showElement(targetElement) {
        ...
        if (oldHelperLayer != null) {
            ...
            self._lastShowElementTimer = setTimeout(function () {
                ...
                var maxwidth = targetElement.getAttribute('data-maxwidth');//g-sid.com 
                if (maxwidth != '') //g-sid.com 
                    oldtooltipLayer.setAttribute("style", 'max-width:' + targetElement.getAttribute('data-maxwidth'));//g-sid.com 
                ...
                window.scroll(500, document.querySelector('.introjs-showElement').offsetTop - 50);//g-sid.com scroll
            }, 350);
            ...
            skipTooltipButton.innerText = this._options.skipLabel;
