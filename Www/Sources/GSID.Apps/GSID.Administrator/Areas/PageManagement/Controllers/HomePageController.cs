...
{
    public partial class HomePageController : BaseAuthenticationController
    {
        ...
        // GET: User
        public HomePageController(IRouteDataUrlService _routeDataUrlService, 
        ...
        [HttpPost]
        public ActionResult EditHomePage([Bind(Include = "TitleVn, TitleEn, SlugVn, SlugEn, DescriptionVn, DescriptionEn, KeywordVn, KeywordEn, RouteDataUrlVnId, RouteDataUrlEnId, H1Vn, H1En, H2Vn, H2En, H3Vn, H3En, H4Vn, H4En, H5Vn, H5En, H6Vn, H6En, OgImageSrc, "
                                                        + "OgTitleVn, OgSite_nameVn, OgDescriptionVn, OgTitleEn, OgSite_nameEn, OgDescriptionEn, OgType, "
                                                        + ", ProductCategoryTitleVn, ProductCategoryTitleEn"
                                                        + ", WhyChooseTitleVn, WhyChooseTitleEn,"
                                                        + ", PostTitleVn, PostTitleEn"
                                                        + ", CareerTitleVn, CareerTitleEn, CareerTakeItem"
                                                        + ", CustomerTitleVn, CustomerTitleEn, CustomerDescriptionVn, CustomerDescriptionEn, MenuActiveId, CareerBackgroundSrc, SectionWhyChooseBackgroundSrc")]HomePageViewModel obj)
        {
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    if (para != null)
                        model = JsonConvert.DeserializeObject<HomePageManagementAdminConfig>(para.Content.ToString());                        
                    ...
                    if (routerVn != null)
                    {
                        ...
                        routerVn.Controller = "Home";
                        routerVn.Action = "HomePage";
                        routerVn.Area = "";
                        routerVn.IsLanguage = RouteDataUrl.RouteDataIsLanguage.Vn;
                        routerVn.IsType = RouteDataUrl.RouteDataIsType.HomePage;
                        //OpenGraphMetaData
                    ...
                    if (routerEn != null)
                    {
                        ...
                        routerEn.Controller = "Home";
                        routerEn.Action = "HomePage";
                        routerEn.Area = "";
                        routerEn.IsLanguage = RouteDataUrl.RouteDataIsLanguage.En;
                        routerEn.IsType = RouteDataUrl.RouteDataIsType.HomePage;
                        //OpenGraphMetaData
                    ...
                    model.ProductCategoryTitleVn = obj.ProductCategoryTitleVn;
                    model.ProductCategoryTitleEn = obj.ProductCategoryTitleEn;
                    model.WhyChooseTitleVn      = obj.WhyChooseTitleVn;
                    model.WhyChooseTitleEn      = obj.WhyChooseTitleEn;

                    model.PostTitleVn           = obj.PostTitleVn;
                    model.PostTitleEn           = obj.PostTitleEn;
                    model.CareerTitleVn         = obj.CareerTitleVn;
                    model.CareerTitleEn         = obj.CareerTitleEn;
                    model.CareerTakeItem        = obj.CareerTakeItem;
                    model.CustomerTitleVn       = obj.CustomerTitleVn;
                    model.CustomerTitleEn       = obj.CustomerTitleEn;
                    model.CustomerDescriptionVn = obj.CustomerDescriptionVn;
                    model.CustomerDescriptionEn = obj.CustomerDescriptionEn;
                    model.MenuActiveId                  = obj.MenuActiveId;
                    model.CareerBackgroundSrc           = obj.CareerBackgroundSrc;
                    model.SectionWhyChooseBackgroundSrc = obj.SectionWhyChooseBackgroundSrc;
