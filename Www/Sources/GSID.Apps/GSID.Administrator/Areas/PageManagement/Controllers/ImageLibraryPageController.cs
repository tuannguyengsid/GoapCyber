...
{
    public class ImageLibraryPageController : BaseAuthenticationController
    {
        ...
        // GET: User
        public ImageLibraryPageController(IRouteDataUrlService _routeDataUrlService,
        ...
        {
            ImageLibraryPageViewModel model = new ImageLibraryPageViewModel();
            ImageLibraryPageManagementAdminConfig paraConfig = new ImageLibraryPageManagementAdminConfig();
            var para = paraService.GetByCode(new ImageLibraryPageManagementAdminConfig().Code);
            if (para != null)
            {
                paraConfig = JsonConvert.DeserializeObject<ImageLibraryPageManagementAdminConfig>(para.Content.ToString());
                model = Mapper.Map<ImageLibraryPageManagementAdminConfig, ImageLibraryPageViewModel>(paraConfig);
        ...
        [HttpPost]
        public ActionResult EditHomePage([Bind(Include = "NameVn, NameEn, TitleVn, TitleEn, SlugVn, SlugEn, DescriptionVn, DescriptionEn, KeywordVn, KeywordEn, RouteDataUrlVnId, RouteDataUrlEnId, , H1Vn, H1En, H2Vn, H2En, H3Vn, H3En, H4Vn, H4En, H5Vn, H5En, H6Vn, H6En, MenuActiveId, OgImageSrc, "
                                                            + "OgTitleVn, OgSite_nameVn, OgDescriptionVn, OgTitleEn, OgSite_nameEn, OgDescriptionEn, OgType, BreakScrumBackgroundSrc")] ImageLibraryPageViewModel obj)
        {
            ...
            try
            {
                ...
                {
                    ImageLibraryPageManagementAdminConfig model = new ImageLibraryPageManagementAdminConfig();

                    var para = paraService.GetByCode(model.Code);
                    if (para != null)
                        model = JsonConvert.DeserializeObject<ImageLibraryPageManagementAdminConfig>(para.Content.ToString());
                    ...
                    if (routerVn != null)
                    {
                        ...
                        routerVn.Controller = "Gallery";
                        routerVn.Action = "Index";
                        routerVn.Area = "";
                        routerVn.IsLanguage = RouteDataUrl.RouteDataIsLanguage.Vn;
                        routerVn.IsType = RouteDataUrl.RouteDataIsType.Gallery;
                        //OpenGraphMetaData
                    ...
                    if (routerEn != null)
                    {
                        ...
                        routerEn.Controller = "Gallery";
                        routerEn.Action = "Index";
                        routerEn.Area = "";
                        routerEn.IsLanguage = RouteDataUrl.RouteDataIsLanguage.En;
                        routerEn.IsType = RouteDataUrl.RouteDataIsType.Gallery;
                        //OpenGraphMetaData
