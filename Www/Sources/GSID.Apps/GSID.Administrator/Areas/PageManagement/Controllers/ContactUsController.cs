...
{
    public class ContactUsController : BaseAuthenticationController
    {
        ...
        public ActionResult Index()
        {
            ...
            ContactUsPageManagementAdminConfig paraConfig = new ContactUsPageManagementAdminConfig();
            var para = paraService.GetByCode(new ContactUsPageManagementAdminConfig().Code);
            if (para != null)
            {
                paraConfig = JsonConvert.DeserializeObject<ContactUsPageManagementAdminConfig>(para.Content.ToString());
                model = Mapper.Map<ContactUsPageManagementAdminConfig, ContactPageViewModel>(paraConfig);
        ...
        [HttpPost]
        public ActionResult EditHomePage([Bind(Include = "NameVn, NameEn, DescriptionPageVn, DescriptionPageEn, TitleVn, TitleEn, SlugVn, SlugEn, DescriptionVn, DescriptionEn, KeywordVn, KeywordEn, RouteDataUrlVnId, RouteDataUrlEnId, H1Vn, H1En, H2Vn, H2En, H3Vn, H3En, H4Vn, H4En, H5Vn, H5En, H6Vn, H6En, OgImageSrc, "
                                                            + "OgTitleVn, OgSite_nameVn, OgDescriptionVn, OgTitleEn, OgSite_nameEn, OgDescriptionEn, OgType, "
                                                            + ", SectionContactUsTitleNameVn, SectionContactUsTitleNameEn, SectionContactUsDescriptionVn, SectionContactUsDescriptionEn, PhoneDescriptionVn, PhoneDescriptionEn, EmailDescriptionVn, EmailDescriptionEn, GoogleMapDescriptionVn, GoogleMapDescriptionEn, GoogleMapUrl, GoogleMapTitleUrlVn, GoogleMapTitleUrlEn"
                                                            + ", GoogleMapEmbedCodeVn, GoogleMapEmbedCodeEn, MenuActiveId, BreakScrumBackgroundSrc")]ContactPageViewModel obj)
        {
            ...
            try
            {
                ...
                {
                    ContactUsPageManagementAdminConfig model = new ContactUsPageManagementAdminConfig();

                    var para = paraService.GetByCode(model.Code);
                    if (para != null)
                        model = JsonConvert.DeserializeObject<ContactUsPageManagementAdminConfig>(para.Content.ToString());
                    ...
                    if (routerVn != null)
                    {
                        ...
                        routerVn.Controller = "ContactUs";
                        routerVn.Action = "Index";
                        routerVn.Area = "";
                        routerVn.IsLanguage = RouteDataUrl.RouteDataIsLanguage.Vn;
                        routerVn.IsType = RouteDataUrl.RouteDataIsType.ContactUs;
                        //OpenGraphMetaData
                    ...
                    if (routerEn != null)
                    {
                        ...
                        routerEn.Controller = "ContactUs";
                        routerEn.Action = "Index";
                        routerEn.Area = "";
                        routerEn.IsLanguage = RouteDataUrl.RouteDataIsLanguage.En;
                        routerEn.IsType = RouteDataUrl.RouteDataIsType.ContactUs;
                        //OpenGraphMetaData
                    ...
                    model.DescriptionPageVn = obj.DescriptionPageVn;
                    model.DescriptionPageEn = obj.DescriptionPageEn;

                    model.SectionContactUsTitleNameVn = obj.SectionContactUsTitleNameVn;
                    model.SectionContactUsTitleNameEn = obj.SectionContactUsTitleNameEn;
                    model.SectionContactUsDescriptionVn = obj.SectionContactUsDescriptionVn;
                    model.SectionContactUsDescriptionEn = obj.SectionContactUsDescriptionEn;
                    model.PhoneDescriptionVn            = obj.PhoneDescriptionVn;
                    model.PhoneDescriptionEn            = obj.PhoneDescriptionEn;
                    model.EmailDescriptionVn            = obj.EmailDescriptionVn;
                    model.EmailDescriptionEn            = obj.EmailDescriptionEn;
                    model.GoogleMapDescriptionVn        = obj.GoogleMapDescriptionVn;
                    model.GoogleMapDescriptionEn        = obj.GoogleMapDescriptionEn;
                    model.GoogleMapUrl                  = obj.GoogleMapUrl;
                    model.GoogleMapTitleUrlVn           = obj.GoogleMapTitleUrlVn;
                    model.GoogleMapTitleUrlEn           = obj.GoogleMapTitleUrlEn;
                    model.GoogleMapEmbedCodeVn = obj.GoogleMapEmbedCodeVn;
                    model.GoogleMapEmbedCodeEn = obj.GoogleMapEmbedCodeEn;
