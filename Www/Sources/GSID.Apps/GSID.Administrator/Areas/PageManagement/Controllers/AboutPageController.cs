...
{
    public partial class AboutPageController : BaseAuthenticationController
    {
        ...
        // GET: User
        public AboutPageController(IRouteDataUrlService _routeDataUrlService,
        ...
        public ActionResult EditHomePage([Bind(Include = "NameVn, NameEn, DescriptionPageVn, DescriptionPageEn, TitleVn, TitleEn, SlugVn, SlugEn, DescriptionVn, DescriptionEn, KeywordVn, KeywordEn, RouteDataUrlVnId, RouteDataUrlEnId, H1Vn, H1En, H2Vn, H2En, H3Vn, H3En, H4Vn, H4En, H5Vn, H5En, H6Vn, H6En, OgImageSrc, "
                                                        ...
                                                        + ", SectionAboutTitleNameVn, SectionAboutTitleNameEn, SectionAboutContentVn, SectionAboutContentEn, SectionAboutContentMoreVn, SectionAboutContentMoreEn, SectionAboutPositionCEOVn, SectionAboutPositionCEOEn, SectionAboutFullNameCEOVn, SectionAboutFullNameCEOEn"
                                                        + ", SectionVisionTitleNameVn, SectionVisionTitleNameEn"
                                                        + ", SectionCoreValueTitleNameVn, SectionCoreValueTitleNameEn"
                                                        + ", MenuActiveId, SectionVisionBackgroundSrc, BreakScrumBackgroundSrc, AvatarCEOImageSrc")]AboutPageViewModel obj)
        {
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    if (para != null)
                        model = JsonConvert.DeserializeObject<AboutPageManagementAdminConfig>(para.Content.ToString());
                    ...
                    if (routerVn != null)
                    {
                        ...
                        routerVn.Controller = "AboutUs";
                        routerVn.Action = "Index";
                        routerVn.Area = "";
                        routerVn.IsLanguage = RouteDataUrl.RouteDataIsLanguage.Vn;
                        routerVn.IsType = RouteDataUrl.RouteDataIsType.AboutUsPage;
                        //OpenGraphMetaData
                    ...
                    if (routerEn != null)
                    {
                        ...
                        routerEn.Controller = "AboutUs";
                        routerEn.Action = "Index";
                        routerEn.Area = "";
                        routerEn.IsLanguage = RouteDataUrl.RouteDataIsLanguage.En;
                        routerEn.IsType = RouteDataUrl.RouteDataIsType.AboutUsPage;
                        //OpenGraphMetaData
                    ...
                    model.SectionAboutTitleNameVn   = obj.SectionAboutTitleNameVn;
                    model.SectionAboutTitleNameEn   = obj.SectionAboutTitleNameEn;
                    model.SectionAboutContentVn     = obj.SectionAboutContentVn;
                    model.SectionAboutContentEn     = obj.SectionAboutContentEn;
                    model.SectionAboutContentMoreVn = obj.SectionAboutContentMoreVn;
                    model.SectionAboutContentMoreEn = obj.SectionAboutContentMoreEn;
                    model.SectionAboutPositionCEOVn = obj.SectionAboutPositionCEOVn;
                    model.SectionAboutPositionCEOEn = obj.SectionAboutPositionCEOEn;
                    model.SectionAboutFullNameCEOVn = obj.SectionAboutFullNameCEOVn;
                    model.SectionAboutFullNameCEOEn = obj.SectionAboutFullNameCEOEn;
                    model.SectionAboutFullNameCEOVn = obj.SectionAboutFullNameCEOVn;
                    model.SectionAboutFullNameCEOEn = obj.SectionAboutFullNameCEOEn;

                    model.SectionVisionTitleNameVn = obj.SectionVisionTitleNameVn;
                    model.SectionVisionTitleNameEn = obj.SectionVisionTitleNameEn;
                    model.SectionVisionBackgroundSrc = obj.SectionVisionBackgroundSrc;
                    model.BreakScrumBackgroundSrc = obj.BreakScrumBackgroundSrc;
                    model.AvatarCEOImageSrc = obj.AvatarCEOImageSrc;

                    model.SectionCoreValueTitleNameVn = obj.SectionCoreValueTitleNameVn;
                    model.SectionCoreValueTitleNameEn = obj.SectionCoreValueTitleNameEn;
