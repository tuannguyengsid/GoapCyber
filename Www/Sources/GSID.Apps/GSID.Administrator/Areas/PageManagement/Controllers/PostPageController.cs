...
{
    public class PostPageController : BaseAuthenticationController
    {
        ...
        // GET: User
        public PostPageController(IRouteDataUrlService _routeDataUrlService,
        ...
        public ActionResult Index()
        {
            ...
            PostPageManagementAdminConfig paraConfig = new PostPageManagementAdminConfig();
            var para = paraService.GetByCode(new PostPageManagementAdminConfig().Code);
            if (para != null)
            {
                paraConfig = JsonConvert.DeserializeObject<PostPageManagementAdminConfig>(para.Content.ToString());
                model = Mapper.Map<PostPageManagementAdminConfig, PostPageViewModel>(paraConfig);
        ...
        [HttpPost]
        public ActionResult EditHomePage([Bind(Include = "NameVn, NameEn, DescriptionPageVn, DescriptionPageEn, TitleVn, TitleEn, SlugVn, SlugEn, DescriptionVn, DescriptionEn, KeywordVn, KeywordEn, RouteDataUrlVnId, RouteDataUrlEnId, , H1Vn, H1En, H2Vn, H2En, H3Vn, H3En, H4Vn, H4En, H5Vn, H5En, H6Vn, H6En, MenuActiveId , OgImageSrc, "
                                                            + "OgTitleVn, OgSite_nameVn, OgDescriptionVn, OgTitleEn, OgSite_nameEn, OgDescriptionEn, OgType, BreakScrumBackgroundSrc")] PostPageViewModel obj)
        {
            ...
            try
            {
                ...
                {
                    PostPageManagementAdminConfig model = new PostPageManagementAdminConfig();

                    var para = paraService.GetByCode(model.Code);
                    if (para != null)
                        model = JsonConvert.DeserializeObject<PostPageManagementAdminConfig>(para.Content.ToString());
                    ...
                    if (routerVn != null)
                    {
                        ...
                        routerVn.IsType = RouteDataUrl.RouteDataIsType.Post;
                        //OpenGraphMetaData
                    ...
                    if (routerEn != null)
                    {
                        ...
                        routerEn.IsType = RouteDataUrl.RouteDataIsType.Post;
                        //OpenGraphMetaData
