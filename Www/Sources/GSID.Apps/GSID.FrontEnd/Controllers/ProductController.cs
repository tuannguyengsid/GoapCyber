...
namespace GSID.FrontEnd.Controllers
{
    public class ProductController : BaseController
    {
        ...
        // GET: Product
        public ActionResult Detail(string language = "", string cateslug = "", string prdslug = "", string urlRouteId = "")
        {
            ...
            if (curentLan != null)
            {
                ...
                if (!string.IsNullOrEmpty(prdslug))
                    model.Product = (curentLan.Country == Language.LanguagueCountry.Vietmamese ? prdService.GetBySlugVn(prdslug) : (curentLan.Country == Language.LanguagueCountry.English ? prdService.GetBySlugEn(prdslug) : null));
